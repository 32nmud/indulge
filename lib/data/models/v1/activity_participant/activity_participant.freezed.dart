...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ActivityParticipant&&(identical(other.participant, participant) || other.participant == participant)&&const DeepCollectionEquality().equals(other.activityCounts, activityCounts));
}
...
@override
String toString() {
  return 'ActivityParticipant(participant: $participant, activityCounts: $activityCounts)';
}
...
class _ActivityParticipant extends ActivityParticipant {
  const _ActivityParticipant({this.participant = const Reference(), final  List<ActivityCount> activityCounts = const []}): _activityCounts = activityCounts,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ActivityParticipant&&(identical(other.participant, participant) || other.participant == participant)&&const DeepCollectionEquality().equals(other._activityCounts, _activityCounts));
}
