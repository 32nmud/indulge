...
mixin _$SexualActivityCategory {
 ...
 String get id; DateTime? get lastUpdateDate; String get name; String? get displayCharacter; int get minParticipants; int get maxParticipants; List<Reference> get activities; bool get requiresPartner;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,lastUpdateDate,name,displayCharacter,minParticipants,maxParticipants,const DeepCollectionEquality().hash(activities),requiresPartner);

@override
String toString() {
  return 'SexualActivityCategory(id: $id, lastUpdateDate: $lastUpdateDate, name: $name, displayCharacter: $displayCharacter, minParticipants: $minParticipants, maxParticipants: $maxParticipants, activities: $activities, requiresPartner: $requiresPartner)';
}
...
@useResult
$Res call({
 String id, DateTime? lastUpdateDate, String name, String? displayCharacter, int minParticipants, int maxParticipants, List<Reference> activities, bool requiresPartner
});
...
/// Create a copy of SexualActivityCategory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? lastUpdateDate = freezed,Object? name = null,Object? displayCharacter = freezed,Object? minParticipants = null,Object? maxParticipants = null,Object? activities = null,Object? requiresPartner = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime? lastUpdateDate,  String name,  String? displayCharacter,  int minParticipants,  int maxParticipants,  List<Reference> activities,  bool requiresPartner)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SexualActivityCategory() when $default != null:
return $default(_that.id,_that.lastUpdateDate,_that.name,_that.displayCharacter,_that.minParticipants,_that.maxParticipants,_that.activities,_that.requiresPartner);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime? lastUpdateDate,  String name,  String? displayCharacter,  int minParticipants,  int maxParticipants,  List<Reference> activities,  bool requiresPartner)  $default,) {final _that = this;
switch (_that) {
case _SexualActivityCategory():
return $default(_that.id,_that.lastUpdateDate,_that.name,_that.displayCharacter,_that.minParticipants,_that.maxParticipants,_that.activities,_that.requiresPartner);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime? lastUpdateDate,  String name,  String? displayCharacter,  int minParticipants,  int maxParticipants,  List<Reference> activities,  bool requiresPartner)?  $default,) {final _that = this;
switch (_that) {
case _SexualActivityCategory() when $default != null:
return $default(_that.id,_that.lastUpdateDate,_that.name,_that.displayCharacter,_that.minParticipants,_that.maxParticipants,_that.activities,_that.requiresPartner);case _:
  return null;
...
class _SexualActivityCategory extends SexualActivityCategory {
  const _SexualActivityCategory({this.id = "", this.lastUpdateDate, required this.name, this.displayCharacter, this.minParticipants = -1, this.maxParticipants = -1, final  List<Reference> activities = const [], this.requiresPartner = false}): _activities = activities,super._();
...
@override@JsonKey() final  int maxParticipants;
 final  List<Reference> _activities;
@override@JsonKey() List<Reference> get activities {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,lastUpdateDate,name,displayCharacter,minParticipants,maxParticipants,const DeepCollectionEquality().hash(_activities),requiresPartner);
...
/// Create a copy of SexualActivityCategory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? lastUpdateDate = freezed,Object? name = null,Object? displayCharacter = freezed,Object? minParticipants = null,Object? maxParticipants = null,Object? activities = null,Object? requiresPartner = null,}) {
