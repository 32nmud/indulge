...
mixin _$ActivityCount {
 ...
 Reference get activityReference; int get count; int get version;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ActivityCount&&(identical(other.activityReference, activityReference) || other.activityReference == activityReference)&&(identical(other.count, count) || other.count == count)&&(identical(other.version, version) || other.version == version));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,activityReference,count,version);

@override
String toString() {
  return 'ActivityCount(activityReference: $activityReference, count: $count, version: $version)';
}
...
@useResult
$Res call({
 Reference activityReference, int count, int version
});
...
/// Create a copy of ActivityCount
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? activityReference = null,Object? count = null,Object? version = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Reference activityReference,  int count,  int version)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActivityCount() when $default != null:
return $default(_that.activityReference,_that.count,_that.version);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Reference activityReference,  int count,  int version)  $default,) {final _that = this;
switch (_that) {
case _ActivityCount():
return $default(_that.activityReference,_that.count,_that.version);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Reference activityReference,  int count,  int version)?  $default,) {final _that = this;
switch (_that) {
case _ActivityCount() when $default != null:
return $default(_that.activityReference,_that.count,_that.version);case _:
  return null;
...
class _ActivityCount extends ActivityCount {
  const _ActivityCount({this.activityReference = const Reference(), this.count = 1, this.version = 2}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ActivityCount&&(identical(other.activityReference, activityReference) || other.activityReference == activityReference)&&(identical(other.count, count) || other.count == count)&&(identical(other.version, version) || other.version == version));
}
...
/// Create a copy of ActivityCount
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? activityReference = null,Object? count = null,Object? version = null,}) {
